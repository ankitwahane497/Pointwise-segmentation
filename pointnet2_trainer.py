...
if __name__=='__main__':
    ...
    pcl_placeholder, label_placeholder = pointnet2_sem_seg.placeholder_inputs(batch_size =1,num_point = 10000)
    is_training_pl = tf.placeholder(tf.bool, shape=())
    net_out, net_pred = pointnet2_sem_seg.get_model(pcl_placeholder, is_training = is_training_pl)
    loss_model = pointnet2_sem_seg.get_loss(net_pred, label_placeholder)
