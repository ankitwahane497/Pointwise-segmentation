...
if __name__=='__main__':
    ...
    pcl_placeholder, label_placeholder = edge_conv_semantic_seg.input_placeholder(batch_size =1,num_point = 10000)
    is_training_pl = tf.placeholder(tf.bool, shape=())
    net_out, net_pred = edge_conv_semantic_seg.get_model(pcl_placeholder, is_training = is_training_pl)
    loss_model = edge_conv_semantic_seg.get_loss(net_pred, label_placeholder)
